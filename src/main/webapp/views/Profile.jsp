                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <small id="pathHelp" class="form-text text-muted">Fake information leads to
                                        jail</small>
                                </div>
                            </div>
                            <div class="col">
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <c:choose>
                                            ...
                                            <c:otherwise>
                                                <input type="tel" value="${contract.phoneNumber}" class="form-control"
                                                            id="phoneNumber"
                                                            placeholder="+7 (___)-___-__-__" data-slots="_"
                                                            disabled="true"
                                                            data-inputmask="'mask': '8(999)-999-99-'"></input>
                                            </c:otherwise>
                                        </c:choose>
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="input-group mb-3">
                                            <c:choose>
                                                <c:when test="${not empty AdminAccess && not empty contract.user.id}">
                                                ...
                                                <c:otherwise>
                                                    <input type="plan" class="form-control" disabled="true" value="${contract.plan.name}"></input>
